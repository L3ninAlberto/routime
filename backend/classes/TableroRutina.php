...
class TableroRutina{
    ...
    function obtenerDatosTablero($id_tablero_rutina){
        ...
        $sql2 = "SELECT a.*, c.color FROM actividad a INNER JOIN color_actividad c ON a.fk_color_actividad = c.id_color_actividad WHERE fk_tablero_rutina = $id_tablero_rutina";
